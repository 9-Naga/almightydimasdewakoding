...
public class LoanReviewService {
    ...
    public LoanReviewService(LoanReviewRepository loanReviewRepository,
    ...
    public LoanReviewResponse getReviewByLoanId(Long loanId) {
        LoanReview review = loanReviewRepository.findByLoanApplicationId(loanId)
                .orElseThrow(() -> new ResourceNotFoundException("Review not found for loan: " + loanId));
