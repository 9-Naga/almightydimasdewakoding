...
public class LoanApplicationService {
    ...
    @Transactional
    public LoanApplicationResponse createLoanApplication(Long userId, LoanApplicationRequest request) {
        // Check if customer has complete profile
        if (!customerProfileService.hasCompleteProfile(userId)) {
            throw new BadRequestException("Please complete your profile including KTP upload before applying for a loan");
        }
