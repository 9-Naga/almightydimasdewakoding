...
public class DisbursementService {
    ...
    public DisbursementResponse processDisbursement(Long loanId, Long processedById) {
        ...
        if (loan.getStatus() != LoanStatus.APPROVED) {
            throw new BadRequestException("Loan application must be approved before disbursement (status: APPROVED)");
        }
    ...
    public DisbursementResponse getDisbursementByLoanId(Long loanId) {
        Disbursement disbursement = disbursementRepository.findByLoanApplicationId(loanId)
    ...
    private DisbursementResponse mapToResponse(Disbursement disbursement) {
        return DisbursementResponse.builder()
                ...
                .processedById(disbursement.getProcessedBy() != null ? disbursement.getProcessedBy().getId() : null)
                .processedByName(disbursement.getProcessedBy() != null ? disbursement.getProcessedBy().getFullname() : null)
                .build();
    }
}
