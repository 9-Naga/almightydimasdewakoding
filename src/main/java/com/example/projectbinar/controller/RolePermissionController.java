...
@Tag(
    ...
    description = "Role and permission management for SUPER_ADMIN")
...
public class RolePermissionController {
  ...
  @Operation(
      ...
      description = "SUPER_ADMIN - Get all roles with their permissions")
  ...
  @Operation(
      ...
      description = "SUPER_ADMIN - Get role details with permissions")
  ...
  @Operation(
      ...
      description = "SUPER_ADMIN - Get all available permissions")
  ...
  @Operation(
      ...
      description = "SUPER_ADMIN - Assign permission to role")
  ...
  @Operation(
      ...
      description = "SUPER_ADMIN - Remove permission from role")
