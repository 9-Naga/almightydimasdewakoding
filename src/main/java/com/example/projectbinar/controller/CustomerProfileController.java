...
public class CustomerProfileController {
  ...
  public CustomerProfileController(
      CustomerProfileService customerProfileService, AuthService authService) {
  ...
  public ResponseEntity<ApiResponse<CustomerProfileResponse>> getMyProfile() {
    ...
    CustomerProfileResponse profile =
        customerProfileService.getProfileByUserId(currentUser.getId());
  ...
  @Operation(
      ...
      description = "Create or update profile for the logged-in user")
  public ResponseEntity<ApiResponse<CustomerProfileResponse>> updateProfile(
      @Valid @RequestBody CustomerProfileRequest request) {
    CustomUserDetails currentUser = authService.getCurrentUser();
    CustomerProfileResponse profile =
        customerProfileService.createOrUpdateProfile(currentUser.getId(), request);
  ...
  @Operation(
      ...
      description = "Check if profile is complete for loan application")
